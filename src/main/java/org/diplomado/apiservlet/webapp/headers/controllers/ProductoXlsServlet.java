...
import org.diplomado.apiservlet.webapp.headers.services.PrroductoServiceImpl;
...
public class ProductoXlsServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ProductoService service = new PrroductoServiceImpl();
        ...
        if (esXls){
            resp.setContentType("aplication/vnd.ms-excel");
